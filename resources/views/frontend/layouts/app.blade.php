...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type":"Organization",
      "name":"JPOS Systems",
      "url":"https://www.jpos.co.ke",
      "logo":"{{ asset('assets/images/logo.png') }}",
      "description":"JPOS Systems supplies POS hardware, laptops, printers, barcode scanners, monitors, networking equipment and business technology solutions in Kenya.",
      "parentOrganization":{
        "@type":"Organization",
      ...
      "sameAs":[
        "https://www.jpos.co.ke",
        "https://www.jminnovatechsolution.co.ke"
      ]
    }
    </script>
    ...
    <style>
        ...
        .hero{
            min-height:100vh;
            background:linear-gradient(135deg,#0B4FA3,#011226);
            color:#fff;
            display:flex;
            align-items:center;
        }
