...
@section('title', 'JPOS Systems Create Brand')
        ...
        <div class="card-body">
            <form action="{{ route('brands.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g., Logitech, HP, Samsung" required>
                    @error('name') 
